...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s dipcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dipcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dipcoin transaction") + "\n" +
              "  dipcoin-tx [options] -create [commands]   " + _("Create hex-encoded dipcoin transaction") + "\n" +
              "\n";
