...
const char * const BITCOIN_CONF_FILENAME = "dipcoin.conf";
const char * const BITCOIN_PID_FILENAME = "dipcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Dipcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Dipcoin";
#else
    // Unix
    return pathRet / ".dipcoin";
#endif
#endif
}
